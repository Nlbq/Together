<div class="main-panel">
  <div class="content-wrapper">
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Modifier une deliverable</h4>
						<?php 
				 Html::input('deliverable_id', 'Deliverable_id', 'text', 'Ex: ', $one_deliverable->getDeliverable_id()); ?><?php 
				 Html::input('delivery_id', 'Delivery_id', 'text', 'Ex: ', $one_deliverable->getDelivery_id()); ?><?php 
				 Html::input('type', 'Type', 'text', 'Ex: ', $one_deliverable->getType()); ?><?php 
				 Html::input('link', 'Link', 'text', 'Ex: ', $one_deliverable->getLink()); ?>
