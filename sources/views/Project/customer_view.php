...
<div class="container customer-projects text-center align-items-center col-6 mb-5 pb-5">
    <p class="customer-projects-title pt-5 pb-2">Mes projets</p>

  <?php foreach ($list_projects as $key => $value): ?>
        <?php 
			if($value['status'] == 1){
				$color="success";
        ...
        ?>  
    <a href="index.php?tab=project&action=view&id=<?= $value['project_id'] ?>" class="p-0">
